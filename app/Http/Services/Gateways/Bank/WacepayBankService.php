...
namespace App\Http\Services\Gateways\Bank;
    ...
    public function process(array $data, string $userId)
    {
        ...
        try {
            ...
            return DB::transaction(function () use ($data, $userId, $user, $beneficiary, $sender, $gateway) {
                ...
                $wTx = $this->waceApiService->sendTransaction($transaction);
                ...
                return Helpers::success(
                    ...
                    'Transaction Bancaire initiée avec succès',
                    201
                );
            });
